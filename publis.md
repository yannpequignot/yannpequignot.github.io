...
> Researchers in all areas have imagined a myriad of abstract objects, many of them infinite, and inevitably followed by an infinite suite.
...
- [**Finite versus infinite: an insufficient shift**](https://arxiv.org/pdf/1612.01435.pdf)
  ...
  [Advances in Mathematics, 2017, 320 (7), 244-249.](https://doi.org/10.1016/j.aim.2017.08.044) Preprint available on [arXiv.org](https://arxiv.org/abs/1612.01435)

- [**A Wadge hierarchy for second countable spaces**](Pdf/YP-AWadgeHierarchy.pdf)

  Archive for Mathematical Logic, 2015, 54 (5), 659–683. The final publication is available at [Springer](http://dx.doi.org/10.1007/s00153-015-0434-y).

- [**From Well to Better, the Space of Ideals**](Pdf/CarroyP2013-FromWellToBetter.pdf)

  [Fundamenta Mathematicae, 2014, 227 (3), 247-270](http://dx.doi.org/10.4064/fm227-3-2). With [Raphaël Carroy](http://www.logique.jussieu.fr/~carroy/indexeng.html).

- [**Duality and the equational theory of regular languages**](Pdf/StoneDualityAndRegularLanguages.pdf)

  Future Directions for Logic: Proceedings of PhDs in Logic III. IfColog Proceedings 2. College Publications.

---

# Ph.D. Thesis

- [**Better-quasi-order: Ideals and Spaces**](Pdf/PhD-Thesis-YPequignot-onscreen.pdf)

  2015, PhD advisors: Jacques Duparc (Lausanne) and Jean-Éric Pin (CNRS, Paris 7).

---

# Selected undergraduate works

- [**Détermination projective**](Pdf/master_thesis.pdf)

  Master thesis (in french), EPFL, July 2010. 

- [**Automates, Langages et Logique**](Pdf/Automata.pdf)

  Semester Project (in french), EPFL, Autumn 2009.

- [**Théorie spectrale et évolution en mécanique quantique**](Pdf/YP-TheorieSpectrale.pdf)

  Semester Project (in french), EPFL, Autumn 2008.

- [**Étude du ollie**](Pdf/TravailDeMaturite.pdf)

  Travail de maturité fédérale (in french), Lycée Blaise Cendrars. 2005. 
